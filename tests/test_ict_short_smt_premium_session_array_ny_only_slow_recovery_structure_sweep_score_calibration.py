...
from research.ict.analyze_ict_short_smt_premium_session_array_ny_only_slow_recovery_structure_sweep_score_calibration import (
    _rank_variants,
    _variant_specs,
)


class ICTShortSmtPremiumSessionArrayNyOnlySlowRecoveryStructureSweepScoreCalibrationTest(unittest.TestCase):
    def test_variant_specs_include_base_and_sweep_score_variants(self) -> None:
        specs = _variant_specs()
        self.assertIn("structure_frontier_base", specs)
        self.assertIn("sweep_score_2", specs)
        self.assertIn("sweep_score_7", specs)
        ...
        ranked = _rank_variants(
            {
                "structure_frontier_base": {
                    ...
                    "params": {"score_liquidity_sweep": 3.0},
                ...
                "sweep_score_4": {
                    ...
                    "params": {"score_liquidity_sweep": 4.0},
                ...
                "sweep_score_7": {
                    ...
                    "params": {"score_liquidity_sweep": 7.0},
                    "metadata": {"fvg_entries": 8, "bullish_sweeps": 155, "bearish_sweeps": 125},
                },
            },
            base_trades=7,
        )
        self.assertEqual(ranked[0]["label"], "sweep_score_4")
