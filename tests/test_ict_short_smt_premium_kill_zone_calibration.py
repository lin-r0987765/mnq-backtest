...
from research.ict.analyze_ict_short_smt_premium_kill_zone_calibration import _rank_variants, _variant_specs


class ICTShortSmtPremiumKillZoneCalibrationTest(unittest.TestCase):
    def test_variant_specs_include_premium_base_and_kill_zone_variants(self) -> None:
