"""
VWAP Mean-Reversion Strategy — v12 保守 partial_tp + ATR 自適應版

改進項目（迭代 #12）：
1. 修復 v11 截斷的 exit 邏輯，完善 partial_tp 實作
2. 更保守 partial_tp 設定（trail=0.003, max_hold=24）改善 OOS Sharpe
3. 新增 ATR 自適應模式：高 ATR 時自動加寬 SL，低 ATR 時收緊入場
"""
